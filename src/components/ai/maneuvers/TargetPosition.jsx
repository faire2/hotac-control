    ...
    return (
        <div className="d-flex flex-column justify-content-center">
            ...
            <ToggleButtonGroup type="radio" name="radio" value={positionContext.aiEngine}
                ...
                {Ships[positionContext.shipType].ai.includes(AI.FGA) &&
                    <ToggleButton value={AI.FGA}>{AI.FGA}</ToggleButton>}
                {Ships[positionContext.shipType].ai.includes(AI.ANDERSON) &&
                    <ToggleButton value={AI.ANDERSON}>{AI.ANDERSON}</ToggleButton>}
            ...
            {/*  Handles visibility of the check-box according to selected Ai engine */
                (positionContext.aiEngine === AI.FGA || positionContext.aiEngine === AI.ANDERSON) &&
                <label>
